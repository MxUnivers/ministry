            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-8">
                        ...
                        <div class="mb-5">
                            <img class="img-fluid w-100 rounded mb-5" src={bgImg} alt="" />
                            <h1 class="text-uppercase mb-4 text-4xl">Diam dolor est labore duo ipsum clita sed et lorem tempor duo</h1>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="d-flex overflow-hidden mb-3">
                                <img class="img-fluid" src={bgImg} style={{ width: "100px", height: "100px", objectFit: "cover" }} alt="" />
